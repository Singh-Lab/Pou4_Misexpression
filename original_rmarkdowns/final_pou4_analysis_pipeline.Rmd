...
* "agg_data_dir_url" contains a link to directory "pou4_data" that only contains the raw CellRanger Count Files "matrix.mtx", "barcodes.tsv" and "genes.tsv"- the necessary inputs for the subsequent analyses. 
